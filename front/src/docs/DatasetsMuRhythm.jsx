...
function DatasetsMuRhythm (props) {
  return (
    <>
      ...
      <DocsParagraph>Final data consisted of 31 ICA components and uploaded into ALICE.</DocsParagraph>
    </>
  )
}

export default DatasetsMuRhythm;